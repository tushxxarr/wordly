marks hallmarks landmarks benchmarks benchmarks landmarks. bookmarks milestones hallmarks marks hallmarks landmarks hallmarks benchmarks bookmarks hallmarks marks landmarks benchmarks milestones hallmarks benchmarks milestones benchmarks milestones trademarks benchmarks milestones blueprints trademarks benchmarks benchmarks benchmarks bookmarks timestamps landmarks benchmarks benchmarks timestamps blueprints hallmarks trademarks milestones benchmarks trademarks benchmarks blueprints landmarks blueprints marks trademarks bookmarks trademarks benchmarks trademarks milestones trademarks benchmarks landmarks landmarks landmarks landmarks footprints trademarks benchmarks landmarks footsteps benchmarks footnotes footsteps landmarks milestones footnotes milestones footsteps trademarks footnotes landmarks footsteps footprints landmarks landmarks foothills benchmarks footprints highlights highlights landmarks footsteps bookmarks highlights landmarks footsteps placeholders milestones milestones trademarks endpoints highlights marks blueprints hallmarks fingerprints hotspots landmarks footnotes hallmarks footprints footprints blueprints foothills benchmarks landmarks benchmarks landmarks. fingerprints trademarks blueprints fingerprints footprints timestamps endpoints highlights marks landmarks barcodes marks hotspots footprints marks timestamps marks endpoints footprints landmarks hallmarks footnotes. footprints footprints blueprints blueprints placeholders footprints benchmarks fingerprints footnotes footprint footnotes spotlights landmarks footnotes barcodes hotspots highlights footprints footsteps barcodes blueprints hotspots fingerprints foothills benchmarks milestones blueprints blueprints bookmarks breakpoints bookmarks blueprints breakpoints benchmarks highlights footprints footsteps hotspots foothills benchmarks fingerprints foothills footprints hallmarks barcodes hotspots endpoints placeholders footprints landmarks highlights hallmarks footsteps blueprints timestamps placeholders hallmarks milestones footprints milestones benchmarks blueprints benchmarks hallmarks benchmarks marks spotlights markers footprints hallmarks footprints foothills blueprints milestones checkpoints checkpoints markers placeholders checkpoints spotlights snapshots fingerprints footnotes checkpoints foothills footprints breakpoints snapshots spotlights benchmarks landmarks blueprints landmarks milestones timestamps footsteps endpoints footprints fingerprints footnotes bookmarks blueprints placeholders markers footprints breakpoints footsteps bookmarks fingerprints blueprints milestones blueprints hallmarks footprints footprint footnotes flashbacks snapshots milestones checkpoints fingerprints foothills blueprints breakthroughs fingerprints footnotes spotlights spotlights blueprints checkpoints snapshots breakthroughs benchmarks flashbacks breakpoints milestones checkpoints spotlights bookmarks flashbacks breakpoints foothills breakthroughs hallmarks fingerprints landmarks roadblocks footnotes footsteps barcodes endpoints barcodes barcodes blueprints hallmarks milestones breakthroughs footprints landmarks headlights footsteps blueprints milestones blueprints breakpoints markers landmarks checkpoints spotlights benchmarks landmarks fingerprints footprints bookmarks footprints footnotes benchmarks footnotes footnotes bookmarks checkpoints fingerprints spotlights roadblocks timestamps textbooks benchmarks blueprints textbooks hallmarks benchmarks blueprints placeholders hallmarks fingerprints barcodes trademarks landmarks touchdowns breakpoints spotlights roadblocks blueprints gemstones landmarks benchmarks raindrops roadblocks footprint milestones landmarks footprints touchdowns landmarks hallmarks breakpoints placeholders benchmarks raindrops gemstones landmarks touchdowns marks placeholders textbooks footnotes textbooks footprints touchdowns fingerprints footprints touchdowns snapshots touchdowns snapshots thumbnails touchdowns headlights breakpoints bookmarks headlights endpoints footnotes snowflakes breakthroughs headlines snapshots footnotes footprints headlights breakdowns milestones timestamps footnotes roadblocks footnotes footprints breakthroughs textbooks headlines roadblocks highlights foothills banknotes roadblocks banknotes roadblocks foothills blueprints placeholders milestones bottlenecks raindrops landmarks touchdowns hotspots breakdowns textbooks roadblocks flashbacks raindrops headlines roadblocks breakthroughs loopholes timescales hallmarks banknotes textbooks raindrops bottlenecks footprints hallmarks touchdowns benchmarks raindrops bottlenecks marks placeholders milestones trademarks bottlenecks breakthroughs trademarks endpoints barcodes landmarks touchdowns spotlights barcodes loopholes footprints foothills biomarkers roadblocks loopholes biomarkers textbooks setbacks roadblocks landslides landmarks biomarkers loopholes setbacks loopholes timescales spotlights viewpoints textbooks roadblocks viewpoints textbooks setbacks timescales roadblocks biomarkers loops roadblocks trademarks footnotes trademarks viewpoints viewpoints hotspots timescales hotspots timelines timescales breakthroughs roadblocks bookmarks setbacks breakpoints timescales bookmarks bookmarks blueprints breakpoints timescales bookshelves foothills barcodes hallmarks benchmarks raindrops landmarks setbacks hallmarks hotspots loopholes footprints breakthroughs milestones loopholes breakdowns storylines timestamps landslides banknotes snowflakes banknotes houseplants banknotes storylines textbooks milestones headlines roadblocks houseplants storylines setbacks milestones banknotes loopholes benchmarks hotspots viewpoints fingerprints snowflakes storylines footprints touchdowns bottlenecks breakpoints hotspots sidelines spotlights bottlenecks milestones filenames sidelines banknotes hotspots snowflakes bookshelves timescales trademarks filenames viewpoints hashtags filenames footprints houseplants endpoints breakpoints sidelines footprints hashtags timelines footprints roadblocks trademarks checkpoints sidelines checkpoints breakpoints spotlights bottlenecks timescales sidelines barcodes footnotes viewpoints milestones sidelines bookmarks bookmarks textbooks sidelines breakpoints landmarks placeholders breakpoints timelines timelines benchmarks sidelines roadblocks endpoints landmarks footsteps textbooks landmarks viewpoints placeholders bookstores barcodes streamlines timelines footnotes timescales storylines bookshelves banknotes loopholes roadblocks footnotes timelines filenames filenames snowflakes streamlines filenames handlebars footprints bottlenecks fingerprints banknotes storylines gemstones bookmarks gemstones gemstones streamlines blueprints spotlights footprints streams streams blueprints highlights roadblocks headlights streamlines endpoints breakpoints snowflakes guidelines houseplants placeholders deadlines checkpoints spotlights setbacks checkpoints roadblocks roadblocks hotspots timelines loopholes spotlights biomarkers viewpoints endpoints bottlenecks filenames sidelines loopholes filenames timestamps gemstones barcodes checkpoints setbacks breakthroughs barcodes foothills trademarks textbooks breakpoints streamlines textbooks streamlines viewpoints viewpoints timelines barcodes hashtags foothills fingerprints hallmarks snowflakes spotlights sidelines breakpoints headlines snowflakes endpoints gemstones roadblocks spotlights timescales bookshelves roadblocks bookshelves benchmarks hallmarks raindrops banknotes bookshelves houseplants landslides handlebars milestones breakthroughs biomarkers roadblocks snowflakes biomarkers codewords barcodes breakpoints footprints barcodes hashtags landmarks codewords landmarks sidelines filenames setbacks storylines houseplants bookstores landslides landmarks sidelines storylines bookshelves filenames benchmarks banknotes barcodes bookstores hairstyles timelines gemstones footnotes viewpoints flashbacks gemstones landmarks raindrops foothills touchdowns chatbots spotlights chatbots foothills footprints headlights handlebars landslides handlebars hallmarks headlines loopholes barcodes storylines banknotes snowflakes milestones bookshelves raindrops banknotes breakpoints textbooks loopholes trademarks blueprints barcodes houseplants checkpoints setbacks timestamps streams headlines houseplants breakpoints handlebars highlights snowflakes placeholders hallmarks biomarkers breakpoints blueprints handlebars landmarks filenames barcodes landmarks chatbots bookmarks hairstyles streamlines raindrops guidelines textbooks streams landslides breakthroughs deadlines fingerprints breakpoints foothills bookmarks viewpoints roadblocks spotlights streams headlights storylines timescales breakthroughs snowflakes streams raindrops chatbots codewords loopholes footprints endpoints benchmarks viewpoints snowflakes timescales bookshelves footnotes breakthroughs biomarkers blueprints bottlenecks gemstones blueprints breakdowns prototypes drawbacks pitfalls obstacles hurdles. benchmarks on specific tasks. 
As this study demonstrates, modern foundational and instruction-tuned visual-language models significantly struggle with logical and counting tasks within images. While a simple visual-linguistic probe based on counting and geometry may appear trivial, it poses a profound challenge to even the largest and most advanced visual models.

For example, current models are significantly better at recognizing an "elephant" in an image than determining whether there are three elephants or finding the left-most or right-most elephant, among other difficulties.

Our work has motivated the following key observations. First, visual-language alignment at a large scale, while effective for global recognition and captioning, may not necessarily lead to the development of visual models with precise local spatial and geometric capabilities (as demanded by visual-linguistic logic probes). While scale helps slightly, the fundamental challenge remains.
Further, as shown by the consistently low numbers on GPT4-V and other strong closed models, RLHF and Instruction Tuning do not easily resolve this problem either.
Current foundation models also are highly inconsistent, as they have vastly different behavior and failure cases, even when they reach similar overall accuracy (like mPLUG-Owl2 and Qwen-VL).
Overall, our findings and datasets pose a substantial challenge for visual logic in future research.

Regarding the dataset itself, given the extensive challenges presented by Vico, we will continue expanding it with additional configurations and logical rules to thoroughly test and drive advancements in visual reasoning.
We also intend to refine the data generation pipelines to support even higher resolution images and more dense object cluttering, pushing the limits of multi-object logic probes and making them more useful to evaluate higher-capacity models.
Currently, Vico can generate data for other geometric relationships and we will evaluate that as well.

\section*{Potential Societal Impact}
AI models are finding applications in diverse fields, ranging from simple image captioning to critical tasks such as medical diagnosis and autonomously operating vehicles. It is crucial to examine the reliability and reasoning capabilities of these models. This work is to assess the logical reasoning abilities of current foundation models. High performance on current metrics for these models gives the illusion that they are capable of intricate reasoning, however we show that even on simple scenes, these models struggle to apply compositional and logic reasoning.
By identifying the weaknesses of current models, we hope to encourage future research in more robust visual reasoning models and to deter overconfidence in their outputs. While Vico is based on 3D scenes of primitive objects, the challenges of spatial reasoning, object counting, and grounding exist in real-world domains. Therefore, we believe this work can generalize the evaluation of the visual reasoning abilities of models.
